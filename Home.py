...
def contact_form():
    ...
    contact_form = """
    <form action="https://formsubmit.co/sharmadit27@gmail.com" method="POST">
...
if selected == "About":
    ...
    If you have any questions or would like to learn more about our medical expenses prediction project, please feel free to reach out to us at [sharmadit27.com](mailto:sharmadit27@gmail.com).
    """)
